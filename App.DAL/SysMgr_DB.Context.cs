...
public partial class SysMgr_DBEntities : DbContext
{
    public SysMgr_DBEntities()
        : base("name=SysMgr_DBEntities")
    {
    ...
    public virtual ObjectResult<P_Sys_GetRightByRoleAndModule_Result_Result> P_Sys_GetRightByRoleAndModule_Result(string roleId, string moduleId)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<P_Sys_GetRightByRoleAndModule_Result_Result>("P_Sys_GetRightByRoleAndModule_Result", roleIdParameter, moduleIdParameter);
    }
